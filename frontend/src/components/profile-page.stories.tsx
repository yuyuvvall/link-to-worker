...
const mockPosts: PostData[] = [
  {
    ...
    title: 'Career Update',
    content:
      'Just landed my dream job as a frontend developer! The interview process was tough but rewarding.',
  ...
  },
  {
    ...
    title: 'Final Project',
    content:
      'Finished my final project in fullstack development.',
    photoUrl: undefined,
    likeCount: 0,
    isLikedByUser: false,
    commentCount: 7,
...
export const ManyPosts: Story = {
  args: {
    ...
    initialPosts: Array.from({ length: 10 }, (_, i) => ({
      ...
      photoUrl:
        i % 3 === 0
          ? `https://picsum.photos/seed/gen${i}/600/400`
          : undefined,
      likeCount: i * 3,
      isLikedByUser: false,
      commentCount: i * 2,
